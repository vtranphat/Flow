...
class BestOutfitsAdapter(val best_posts: ArrayList<String>, val photo: ArrayList<String>, val numberOfLike: ArrayList<Long>, val identifantPost: ArrayList<String>) : RecyclerView.Adapter<BestOutfitsAdapter.ViewHolder>() {


    /*val imgOutfit : ImageView= itemView.findViewById(R.id.img_like)
    mImageOutFit = findViewById(R.id.img_like)*/
    override fun getItemCount() = best_posts.count()


    override fun onBindViewHolder(holder:ViewHolder, position: Int) {
        holder.weshBoo.text = best_posts[position]
        holder.userLike.text = numberOfLike[position].toString(10)
        //holder.imgOutfit.setImageBitmap()
        println("NEW PP" + numberOfLike)
